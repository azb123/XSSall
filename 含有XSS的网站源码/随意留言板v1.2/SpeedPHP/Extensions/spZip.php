...
class spZip {
		...
		function download($filename = 'backup.zip')
	{
		...
		spZip::force_download($filename, $zip_content);
	}
...
//添加字符串$name='1.txt' $data='hello',add_data($name,$data) 下载
//压缩文件夹里面文件 $name='./tmp/' read_dir($name) 下载
//压缩文件 $name='./tmp/1.txt' read_file($name) 下载

...
<div class="right_body"> 
    ...
    <!-- 右侧主体内容开始 -->
    <div class="mbody">
        <div style="background:#fef3e8;clear:both;border:1px solid orange;padding:5px;">本页功能对服务器资源消耗较多，为了给站长提供更好的服务，收取增值服务费用：800元/年，需要开通的站长请 <a href="http://www.appcms.cc" target="_blank"><font color=red><b>点此咨询</b></font></a></div>
        <!--定时更新-->

                ...
                <form id="set" >
                    <div id="tab1">
                        <table class="tb3" style="clear:both;width:100%;" >
                            ...
                            <tr>
                                <td>PC站模板风格：</td>
                                <td class="alignleft" ><?php show();?> <font color=red> * 更换模板时，为防止第三方制作模板含有安全隐患，请注意弹出的安全提示信息</font></td>
                            </tr>
                            <tr>
                                <td>评论代码：</td>
                                <td class="alignleft" >
                    ...
                    <div id="tab5">
                        <table class="tb3" style="clear:both;width:100%;" >
							...
							<tr>
                                <td>赚钱联盟ID：</td>
                                <td class="alignleft" ><input class="ipt" id="union_id" style="width:50px" value="<?php if(defined('UNION_ID')) echo UNION_ID;?>"> 赚钱联盟的账号数字ID，在 <a href="http://322.com.cn" target="_blank">http://322.com.cn</a> 中注册登录后即可获取</td>
                            </tr>
                            <tr>
                                <td>后台登录认证码：</td>
